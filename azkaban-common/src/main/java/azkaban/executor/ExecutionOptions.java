...
public class ExecutionOptions {
  ...
  public boolean isFailureSmsOverride() {    return this.failureSmsOverride;  }
  public void setFailureSmsOverride(final boolean failureSmsOverride) {
    this.failureSmsOverride = failureSmsOverride;
  }
  public boolean isSuccessSmsOverride() {
    return this.successSmsOverride;
  }
  public void setSuccessSmsOverride(boolean successSmsOverride) {
    this.successSmsOverride = successSmsOverride;
  }
  public ArrayList<String> getFailureSms() {
    return this.failureSms;
  }
  public void setFailureSms(final Collection<String> failureSms) {
    if(failureSms!=null&&failureSms.size()>0)
    this.failureSms = new ArrayList<>(failureSms);
  }

  public ArrayList<String> getSuccessSms() {
    return this.successSms;
  }

  public void setSuccessSms(final Collection<String> successSms) {
    if(successSms!=null&&successSms.size()>0)
    this.successSms = new ArrayList<>(successSms);
  }
  ...
  public boolean getSmsOnFirstFailure() {
    return this.smsOnFirstFailure;
  }

  public void setSmsOnFirstFailure(final boolean smsOnFirstFailure) {
    this.smsOnFirstFailure = smsOnFirstFailure;
  }

  public boolean getSmsOnLastFailure() {
    return this.smsOnLastFailure;
  }

  public void setSmsOnLastFailure(final boolean smsOnLastFailure) {
    this.smsOnLastFailure = smsOnLastFailure;
  }
